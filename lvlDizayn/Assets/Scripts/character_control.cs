...
public class Character_Control : MonoBehaviour
{
    ...
    {
        // --- ÖNEMLİ DEĞİŞİKLİK ---
        // Eğer savruluyorsak hareket kodunu çalıştırma!
        // Böylece Rigidbody'ye uygulanan güç iptal olmaz.
        if (isKnockedBack) return; 
    ...
    public void ApplyKnockback(Vector2 direction, float force)
    {
        ...
        // Kısa süre sonra kontrolü geri ver
        StartCoroutine(ResetKnockbackRoutine());
    }

    // Savrulma bittikten sonra kontrolü geri veren zamanlayıcı
    IEnumerator ResetKnockbackRoutine()
    {
        // 0.2 saniye boyunca fiziksel güç etkili olsun, oyuncu müdahale edemesin
